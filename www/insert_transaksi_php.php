...
<head>
 ...
 $.ajax({
 type: "POST",
 url:"https://webservsendayu.000webhostapp.com/insert_transaksi.php",
 data: dataString,
 crossDomain: true,
 cache: false,
...
<?php
$db = mysql_connect('localhost','id6374924_sendayu','Unisbank01*') or die("Database error");
mysql_select_db('id6374924_pembelian', $db);
...
/*
$connection = mysqli_connect("localhost","id6374924_sendayu","Unisbank01*");
if (!$connection) {
    die("Database connection failed: " . mysqli_connect_error());
}

$db_select = mysqli_select_db($connection, "id6374924_pembelian");
if (!$db_select) {
...
/*
$connection =mysqli_connect("localhost","id6374924_sendayu","Unisbank01*","id6374924_pembelian") or die (mysqli_error());
mysqli_select_db("id6374924_pembelian",$connection) or die (mysqli_error());
*/
